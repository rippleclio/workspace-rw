...
start "wabifair-storefront-web" cmd /c "cd /d %ROOT_DIR%\wabifair-storefront-web && npm run dev"

echo [2/4] wabifair-admin-console   (port 3001)
start "wabifair-admin-console" cmd /c "cd /d %ROOT_DIR%\wabifair-admin-console && npm run dev"

echo [3/4] rippleclio-web           (port 5173)
start "rippleclio-web" cmd /c "cd /d %ROOT_DIR%\rippleclio-web && npm run dev"

echo [4/4] rippleclio-admin-console (port 5174)
start "rippleclio-admin-console" cmd /c "cd /d %ROOT_DIR%\rippleclio-admin-console && npm run dev"
...
echo.
echo Use scripts\stop-frontends.bat to shut them all down.
